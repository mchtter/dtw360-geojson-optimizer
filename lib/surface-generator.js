document.getElementById("submit").addEventListener("click", () => {
  ...
  geojson.features.forEach((feature, index) => {
    if (feature.properties.height == null) return;

    parsedData.push({
      Name: feature.properties.Name,
      ID: feature.properties.ID,
      type: "Surface",
      surfaceID: feature.properties.ID,

      height: feature.properties.height,
      rowIndex: feature.properties.row_index,
      colIndex: feature.properties.col_index,
      coordinate: `(X=${feature.geometry.coordinates[0].toFixed(6)},Y=${feature.geometry.coordinates[1].toFixed(6)})`,
    });
  });
